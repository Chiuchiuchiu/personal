...
<head>
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" href="/newPersonal/Public/css/Home/animate.css">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="/newPersonal/Public/css/Home/icomoon.css">
    <!-- Magnific Popup-->
    <link rel="stylesheet" href="/newPersonal/Public/css/Home/magnific-popup.css">
    <!-- Owl Carousel -->
    <link rel="stylesheet" href="/newPersonal/Public/css/Home/owl.carousel.min.css">
    <link rel="stylesheet" href="/newPersonal/Public/css/Home/owl.theme.default.min.css">
    <!-- Bootstrap  -->
    <link rel="stylesheet" href="/newPersonal/Public/css/Home/bootstrap.css">

    <!-- Cards -->
    <link rel="stylesheet" href="/newPersonal/Public/css/Home/cards.css">

    <!-- Modernizr JS -->
    <script src="/newPersonal/Public/js/Home/modernizr-2.6.2.min.js"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
    <script src="/newPersonal/Public/js/Home/respond.min.js"></script>
    <![endif]-->
...
<div class="fh5co-cover fh5co-cover-style-2 js-full-height" data-stellar-background-ratio="0.5" data-next="yes"  style="background-image: url(/newPersonal/Public/images/Home/header_bg.jpg);">
    ...
    <div class="container">
        <div class="row p-b">
            <div class="col-md-6 col-md-offset-3 text-center">
                <h2 class="fh5co-heading wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">参与项目</h2>
                <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">People in the eyes of the talent is remarkable, not a genius, but a constant effort to pay. Exercise 10 thousand hours is necessary for any people to become extraordinary from the ordinary.</p>
            </div>
        </div>
    </div>
    <div class="fh5co-projects">
        <ul>
            <li class="wow fadeInUp" style="background-image: url(/newPersonal/Public/images/Home/xixun1.png);" data-wow-duration="1s" data-wow-delay="1.4s" data-stellar-background-ratio="0.5">
                        ...
                        <div class="fh5co-text">
                            <div class="fh5co-text-inner">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <p> 依托领先的SaaS服务技术和移动互联网理念，
                                            提供了创新及完善的顶岗实习全流程解决方案，
                                            使校内校外、线上线下、岗前岗中岗后等所有环节形成一个有机的整体。
                                            产品贴合学校的顶岗实习工作，
                                            真正实现顶岗实习标准化、科学化、系统化的教学管理和实习就业综合服务。
                                        </p></div>
                                </div>
                            </div>
                        </div>
            ...
            <li class="wow fadeInUp" style="background-image: url(/newPersonal/Public/images/Home/full_4.jpg);" data-wow-duration="1s" data-wow-delay="1.4s" data-stellar-background-ratio="0.5">
                <a>
                    <div class="fh5co-overlay"></div>
                    <div class="container">
                        <div class="fh5co-text">
            ...
            <!--<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">-->
                <!--<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.1s">-->
                    <!--<div class="fh5co-post-image">-->
                        ...
                        <!--<img src="/newPersonal/Public/images/Home/img_same_dimension_2.jpg" alt="Image" class="img-responsive">-->
                    <!--</div>-->
            ...
            <!--<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">-->
                <!--<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.4s">-->
                    <!--<div class="fh5co-post-image">-->
                        ...
                        <!--<img src="/newPersonal/Public/images/Home/img_same_dimension_3.jpg" alt="Image" class="img-responsive">-->
                    <!--</div>-->
                    <!--<div class="fh5co-post-text">-->
            ...
            <!--<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">-->
                <!--<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.7s">-->
                    <!--<div class="fh5co-post-image">-->
                        ...
                        <!--<img src="/newPersonal/Public/images/Home/img_same_dimension_4.jpg" alt="Image" class="img-responsive">-->
                    <!--</div>-->
                    <!--<div class="fh5co-post-text">-->
...
<!--<div class="fh5co-features-style-1" style="background-image: url(/newPersonal/Public/images/Home/full_4.jpg);" data-stellar-background-ratio="0.5">-->
    <!--<div class="fh5co-overlay"></div>-->
        ...
        <!--<div class="row">-->
            <!--<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">-->
                <!--<a href="#" class="link-block">-->
                    <!--<figure><img src="/newPersonal/Public/images/Home/img_same_dimension_1.jpg" alt="Image" class="img-responsive img-rounded"></figure>-->
            ...
            <!--<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".8s">-->
                <!--<a href="#" class="link-block">-->
                    <!--<figure><img src="/newPersonal/Public/images/Home/img_same_dimension_2.jpg" alt="Image" class="img-responsive img-rounded"></figure>-->
                    <!--<h3>Retina Ready</h3>-->
                    <!--<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>-->
                <!--</a><p><a href="#" class="link-block"></a><a href="#" class="btn btn-primary btn-sm">Learn More</a></p>-->
            ...
            <!--<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.1s">-->
                <!--<a href="#" class="link-block">-->
                    <!--<figure><img src="/newPersonal/Public/images/Home/img_same_dimension_3.jpg" alt="Image" class="img-responsive img-rounded"></figure>-->
            ...
            <!--<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.4s">-->
                <!--<a href="#" class="link-block">-->
                    <!--<figure><img src="/newPersonal/Public/images/Home/img_same_dimension_4.jpg" alt="Image" class="img-responsive img-rounded"></figure>-->
                    <!--<h3>Responsive Layout</h3>-->
                    <!--<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>-->
                <!--</a><p><a href="#" class="link-block"></a><a href="#" class="btn btn-primary btn-sm">Learn More</a></p>-->
...
<!--<div class="fh5co-counter-style-2" style="background-image: url(/newPersonal/Public/images/Home/full_2.jpg);" data-stellar-background-ratio="0.5">-->
    <!--<div class="fh5co-overlay"></div>-->
    <!--<div class="container">-->
        ...
        <div class="container">
            <div class="row p-b">
                <div class="col-md-3 col-sm-6 fh5co-footer-widget wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                    <div class="fh5co-logo"><span class="logo">C</span> Chiu</div>
                    <p class="fh5co-copyright">&copy; 2016 Chiu. <br>All Rights Reserved.
                    </p>
                </div>
                <div class="clearfix visible-sm-block"></div>
...
<!-- jQuery -->
<script src="/newPersonal/Public/js/Home/jquery.min.js"></script>
<!-- jQuery Easing -->
<script src="/newPersonal/Public/js/Home/jquery.easing.1.3.js"></script>
<!-- Bootstrap -->
<script src="/newPersonal/Public/js/Home/bootstrap.min.js"></script>
<!-- Waypoints -->
<script src="/newPersonal/Public/js/Home/jquery.waypoints.min.js"></script>
<!-- Owl Carousel -->
<script src="/newPersonal/Public/js/Home/owl.carousel.min.js"></script>
<!-- Magnific Popup -->
<script src="/newPersonal/Public/js/Home/jquery.magnific-popup.min.js"></script>
<!-- Stellar -->
<script src="/newPersonal/Public/js/Home/jquery.stellar.min.js"></script>
<!-- countTo -->
<script src="/newPersonal/Public/js/Home/jquery.countTo.js"></script>
<!-- WOW -->
<script src="/newPersonal/Public/js/Home/wow.min.js"></script>
<script>
    new WOW().init();
</script>
<!-- Main -->
<script src="/newPersonal/Public/js/Home/main.js"></script>
